...
#define PIN_RELAY_PUMP_FILL 16 // Pump 1: Fish Tank Water Filling
#define PIN_RELAY_TDS_1 17     // Pump 2: TDS Correction (e.g., Drain/Replace)
#define PIN_RELAY_TDS_2 21     // Pump 3: TDS Correction (e.g., Add Minerals)
#define PIN_RELAY_PH_UP 22     // Pump 4: pH Up Solution
#define PIN_RELAY_PH_DOWN 23   // Pump 5: pH Down Solution
#define PIN_RELAY_SOLENOID 33  // Solenoid Valve: Drain/Clean (Turbidity High)
